...
##Pmod Header JD                                                                                                                                                                                                                             
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33     } [get_ports { o_DAC_NCS }]; #IO_L5P_T0_34 Sch=jd_p[1]                  
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33     } [get_ports { o_DAC_D0 }]; #IO_L5N_T0_34 Sch=jd_n[1]				 
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33     } [get_ports { o_DAC_D1 }]; #IO_L6P_T0_34 Sch=jd_p[2]                  
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33     } [get_ports { o_DAC_CLK }]; #IO_L6N_T0_VREF_34 Sch=jd_n[2]                      

###Pmod Header JD -- Quand le 8LD est plugger                                                                                                                  
...
##Pmod Header JA                                                                                                                  
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { Pmod_OLED[0] }]; 				 
set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { Pmod_OLED[1] }];                
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { Pmod_OLED[2] }];                
set_property -dict { PACKAGE_PIN K14   IOSTANDARD LVCMOS33 } [get_ports { Pmod_OLED[3] }];                
set_property -dict { PACKAGE_PIN N16  IOSTANDARD LVCMOS33 } [get_ports { Pmod_OLED[4] }];                
set_property -dict { PACKAGE_PIN L15  IOSTANDARD LVCMOS33 } [get_ports { Pmod_OLED[5] }];                
set_property -dict { PACKAGE_PIN J16   IOSTANDARD LVCMOS33 } [get_ports { Pmod_OLED[6] }];                
set_property -dict { PACKAGE_PIN J14   IOSTANDARD LVCMOS33 } [get_ports { Pmod_OLED[7] }]; 
