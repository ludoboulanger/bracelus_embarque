...
proc checkRequiredFiles { origin_dir} {
  ...
  set files [list \
   ...
   "$origin_dir/../vhdSources/calories_brulees.vhd" \
   "$origin_dir/../vhdSources/mef_calories_brulees.vhd" \
   ...
   "$origin_dir/../testbenches/cardio_tb.vhd" \
  ]
  foreach ifile $files {
  ...
  set paths [list \
   [file normalize "$origin_dir/../ipRepo/CardioAnalyseIP_1.0"] \
   [file normalize "$origin_dir/../ipRepo/MouvAnalyseIP_1.0"] \
...
set orig_proj_dir "[file normalize "$origin_dir/../work/bracelus_vhdl"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../ipRepo"] [file normalize "$origin_dir/../vivado-library-2020.1"]" $obj
...
set files [list \
 ...
 [file normalize "${origin_dir}/../vhdSources/calories_brulees.vhd"]\
 [file normalize "${origin_dir}/../vhdSources/mef_calories_brulees.vhd"]\
]
...
set file "${origin_dir}/../vhdSources/compteur_nbits.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "${origin_dir}/../vhdSources/dac_mef.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "${origin_dir}/../vhdSources/registre_12b.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "${origin_dir}/../vhdSources/registre_16b.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "${origin_dir}/../vhdSources/calories_brulees.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "${origin_dir}/../vhdSources/mef_calories_brulees.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/../testbenches/top_tb.vhd"]\
 ...
 [file normalize "${origin_dir}/../testbenches/cardio_tb.vhd"]\
]
add_files -norecurse -fileset $obj $files
...
set file "${origin_dir}/../testbenches/top_tb.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "${origin_dir}/../testbenches/fichier_top_tb.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "${origin_dir}/../testbenches/ctrl_DAC_tb.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "${origin_dir}/../testbenches/Ctrl_AD1_tb.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "${origin_dir}/../testbenches/cardio_tb.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
